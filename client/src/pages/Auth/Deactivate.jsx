        ...
        <div className="flex w-full items-start p-4 h-full ">
            <div className="w-[50%] p-2 border-r-2 h-full">
                <div>
                    ...
                    <div className="text-[10px] text-slate-500 p-4">
                        <ul className="list-disc leading-6">
                            ...
                            <li>
                                Your reviews/ratings are still visible, while
                                your profile information is shown as
                            ...
                            <li>
                                ...
                                Wishlist is shown as ‘unavailable’ as a result
                                of deactivation
                            </li>
                            <li>
            ...
            <div className="w-[50%] flex flex-col gap-5 items-center p-2  ">
                <div className="w-full font-[500] text-[14px] text-center leading-7">
                ...
                <div className="">
                    ...
                    >
                        ...
                        <div className="relative flex items-center">
                            <button className="bg-primaryBlue w-full uppercase text-white text-[12px] font-[500] rounded-sm px-2 py-1">
                                Deactivate
                            </button>
                        </div>
                    </form>
                ...
                <Link
                    to="/"
                    className="uppercase text-primaryBlue font-[600] text-[12px] flex items-center justify-center w-full"
                >
                    No, Let me Stay
                </Link>
            </div>
