            ...
            <div className="w-full flex flex-col sm:flex-row bg-white sm:p-2 relative">
              ...
              <div className="w-full sm:w-2/5 sm:sticky top-16 sm:h-screen">
                ...
                <div className="flex flex-col gap-3 m-3 ">
                  ...
                  <div className="w-full bg-white md:static fixed bottom-0 flex gap-1 z-10 md:gap-3 left-0 px-0 max-w-full">
                    {/* <!-- add to cart btn --> */}
                    {product.stock > 0 && (
                      <button
              ...
              <div className="flex py-2 px-3">
                ...
                <div className="flex flex-col gap-3 mb-4">
                  ...
                  {[
                    ...
                    <p className="flex gap-2 text-[14px] leading-5" key={i}>
                      <LocalOfferIcon
                        sx={{
                          fontSize: "16px",
                        }}
                  ...
                  <div className="flex gap-8 mt-2 items-center text-sm">
                    ...
                    <Link className="font-medium text-primaryBlue -ml-5" to="/">
                      Know More
                    </Link>
                  </div>
                  {/* <!-- warranty & brand --> */}
                  ...
                  <div className="flex gap-16 mt-4 items-center text-sm font-medium">
                    ...
                    <Link className="font-medium text-primaryBlue ml-3" to="/">
                      {product?.brand?.name}
                    </Link>
                  </div>
                  {/* <!-- seller details --> */}
